    ...
    const TrainingExamsTab = () => {
        ...
        return (
            <div>
                ...
                <Table>
                    <TableHeader><TableRow><TableHead>Sınav</TableHead><TableHead>Eğitim</TableHead><TableHead>Geçme Notu</TableHead><TableHead className="text-right">İşlemler</TableHead></TableRow></TableHeader>
                    <TableBody>
                        {exams.map(exam => (
