                ...
                {selectedTrainingId && (
                    <>
                        ...
                        <div className="rounded-md border mt-4">
                            <Table>
                                <TableHeader><TableRow><TableHead>Doküman Adı</TableHead><TableHead>Yüklenme Tarihi</TableHead><TableHead className="text-right">İşlemler</TableHead></TableRow></TableHeader>
                                <TableBody>
