                ...
                <table className="data-table data-table-wide" style={{ minWidth: '1600px' }}>
                    <thead>
                        <tr>
                            ...
                            <th className="sticky right-0 bg-card px-4 py-2 text-center whitespace-nowrap min-w-[100px] z-20 border-l border-border shadow-[2px_0_4px_rgba(0,0,0,0.1)]">İşlemler</th>
                        </tr>
                    </thead>
                    <tbody>
                        {records.map((record) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="sticky right-0 bg-card border-t border-l border-border px-4 py-2 text-sm text-center whitespace-nowrap z-20 shadow-[2px_0_4px_rgba(0,0,0,0.1)]" onClick={(e) => e.stopPropagation()}>
                                        <DropdownMenu>
