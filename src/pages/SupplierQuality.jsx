...
const SupplierQuality = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Tedarikçi Kalite Yönetimi - Kademe Kalite Yönetimi</title>
        <meta name="description" content="Tedarikçi performansı ve kalite takibi." />
      </Helmet>
      <motion.div 
      ...
      >
        <h1 className="text-3xl font-bold mb-4">Tedarikçi Kalite Yönetimi</h1>
