...
const QuarantineManagement = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Karantina Yönetimi - Kademe Kalite Yönetimi</title>
        <meta name="description" content="Karantinaya alınan ürünlerin yönetimi." />
      </Helmet>
      <motion.div 
      ...
      >
        <h1 className="text-3xl font-bold mb-4">Karantina Yönetimi</h1>
