    ...
    export const DataProvider = ({ children }) => {
        ...
        const fetchData = useCallback(async () => {
            ...
            const promises = {
                ...
                stockRiskControls: supabase.from('stock_risk_controls').select('*, source_inspection:source_inspection_id!left(record_no, inspection_date), controlled_inspection:controlled_inspection_id!left(record_no, inspection_date), supplier:supplier_id!left(name), controlled_by:controlled_by_id!left(profiles(full_name))'),
