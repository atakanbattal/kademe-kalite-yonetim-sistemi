...
async def run_test():
    ...
    try:
        ...
        # -> Input valid username/email and password and click the login button.
        ...
        frame = context.pages[-1]
        # Click on the login button to submit login form
        ...
        await expect(frame.locator('text=Ana Panel').nth(1)).to_be_visible(timeout=30000)
