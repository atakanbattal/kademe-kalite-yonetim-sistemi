-- Uzak ortamda kalmış eski backfill_kpi_monthly_data (ELSIF zinciri) supplier_nc_rate vb.
-- auto_kpi_id'leri kapsamıyordu; kpi_monthly_actual ile tek kaynak kullanılsın.
